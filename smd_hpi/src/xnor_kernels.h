...
#ifndef MXNET_SMD_HPI_SRC_XNOR_KERNELS_H
#define MXNET_SMD_HPI_SRC_XNOR_KERNELS_H
#include <vector>
#include <iostream>
...
inline int get_next_block_dim(int m, int n, int k){	
	...
	// TODO, to try: sorting, selecting bigger divisor ???
	if (!divs.empty()){
...
#endif /* MXNET_SMD_HPI_SRC_XNOR_KERNELS_H */
