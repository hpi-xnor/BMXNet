...
def Conv(data, num_filter, kernel=(1, 1), stride=(1, 1), pad=(0, 0), name=None, suffix=''):
    conv = mx.sym.Convolution(data=data, num_filter=num_filter, kernel=kernel, stride=stride, pad=pad, no_bias=1, name='%s%s_Qconv2d' %(name, suffix))
...
def QConv(data, num_filter, kernel=(1, 1), stride=(1, 1), pad=(0, 0), name=None, suffix=''):
    ...
    Qconv = mx.sym.QConvolution(data=act, num_filter=num_filter, kernel=kernel, stride=stride, pad=pad, no_bias=1, name='%s%s_Qconv2d' %(name, suffix), 
