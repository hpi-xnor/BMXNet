...
def ConvFactory(data, num_filter, kernel, stride=(1, 1), pad=(0, 0), act_type="relu", mirror_attr={}, with_bn_out=False):
    ...
    if with_bn_out:
        bn2 = mx.symbol.BatchNorm(data=conv)
        return bn2
    else:
        return conv
...
def get_symbol(num_classes=1000, **kwargs):
    ...
    conv2b_3_3 = ConvFactory(conv2a_3_3, 64, (3, 3), pad=(1, 1), with_bn_out=True)
    ...
    conv4a_3_3 = ConvFactory(conv3b_1_1, 192, (3, 3), with_bn_out=True)
    ...
    tower_conv1_2 = ConvFactory(tower_conv1_1, 384, (3, 3), stride=(2, 2), with_bn_out=True)
    ...
    tower_conv2_2 = ConvFactory(tower_conv2_1, 320, (3, 3),  stride=(2, 2), with_bn_out=True)
    tower_pool = mx.symbol.Pooling(net, kernel=(
        3, 3), stride=(2, 2), pool_type='max')
    ...
    net = ConvFactory(net, 1536, (1, 1), with_bn_out=True)
