...
def get_binary_lenet():
	...
	conv2 = mx.sym.QConvolution(data=ba1, kernel=(5,5), num_filter=64, act_bit=BITA, weight_bit=BITW, cudnn_off=False, gradient_update_mode='bf')
	bn2 = mx.sym.BatchNorm(data=conv2)
	...
	fc1 = mx.symbol.QFullyConnected(data=ba2, num_hidden=1000, act_bit=BITA, weight_bit=BITW, gradient_update_mode='bf')
