...
def get_symbol_train(num_classes=20):
    ...
    conv2_2 = mx.symbol.QConvolution(
        data=relu2_1, kernel=(3, 3), pad=(1, 1), num_filter=128, name="conv2_2", act_bit=1)
    ...
    conv3_2 = mx.symbol.QConvolution(
        data=relu3_1, kernel=(3, 3), pad=(1, 1), num_filter=256, name="conv3_2", act_bit=1)
    relu3_2 = mx.symbol.Activation(data=conv3_2, act_type="relu", name="relu3_2")
    conv3_3 = mx.symbol.QConvolution(
        data=relu3_2, kernel=(3, 3), pad=(1, 1), num_filter=256, name="conv3_3", act_bit=1)
    ...
    conv4_2 = mx.symbol.QConvolution(
        data=relu4_1, kernel=(3, 3), pad=(1, 1), num_filter=512, name="conv4_2", act_bit=1)
    relu4_2 = mx.symbol.Activation(data=conv4_2, act_type="relu", name="relu4_2")
    conv4_3 = mx.symbol.QConvolution(
        data=relu4_2, kernel=(3, 3), pad=(1, 1), num_filter=512, name="conv4_3", act_bit=1)
    ...
    conv5_2 = mx.symbol.QConvolution(
        data=relu5_1, kernel=(3, 3), pad=(1, 1), num_filter=512, name="conv5_2", act_bit=1)
    relu5_2 = mx.symbol.Activation(data=conv5_2, act_type="relu", name="relu5_2")
    conv5_3 = mx.symbol.QConvolution(
        data=relu5_2, kernel=(3, 3), pad=(1, 1), num_filter=512, name="conv5_3", act_bit=1)
    ...
    conv7 = mx.symbol.QConvolution(
        data=relu6, kernel=(1, 1), pad=(0, 0), num_filter=1024, name="conv7", act_bit=1)
